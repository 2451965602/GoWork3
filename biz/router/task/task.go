...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		...
		{
			_querylist := _task.Group("/querylist", _querylistMw()...)
			_querylist.GET("/keyword", append(_querytasklistbykeywordMw(), task.QueryTaskListByKeyword)...)
			_querylist.GET("/status", append(_querytaskbystatusMw(), task.QueryTaskByStatus)...)
		}
	}
}
